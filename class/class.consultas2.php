...
class consultas
{
    ...
    public function get_form($id = NULL)
    {
        ...
        $html = '
        <form name="Form_Consulta" method="POST" action="consultas2.php" enctype="multipart/form-data">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                    <a href="consultas2.php" class="btn btn-primary">Regresar</a>
    ...
    public function get_list()
    {
        ...
        $res = $this->con->query($sql);
        // Sin codificar <td><a href="consultas2.php?op=del&id=' . $row['id'] . '">Borrar</a></td>
        while ($row = $res->fetch_assoc()) {
            ...
            <tr>
                ...
                <td class="text-center"><button class="btn btn-info"><a href="consultas2.php?d=' . $d_det_final . '">Detalle</a></button></td>
            </tr>';
        }
        $html .= '</table>';
        return $html;
    ...
    private function _message_error($tipo)
    {
		...
		<table border="0" align="center">
			...
			<tr>
				<th><a href="consultas2.php">Regresar</a></th>
			</tr>
		</table>';
        return $html;
    }
