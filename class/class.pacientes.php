                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td><label for="Nombre" class="col-md-4 col-form-label">Paciente:</label></td>
                                    <td><input type="text" class="form-control" size="15" name="Nombre" value="' . $this->Nombre . '" required></td>
                                </tr>
                                <tr>
                                    <td><label for="IdUsuario" class="col-md-4 col-form-label">Nombre de Usuario:</label></td>
                                    <td><input type="text" class="form-control" size="15" name="IdUsuario" value="' . $this->IdUsuario . '" required></td>
                                </tr>
                                <tr>
                                    <td><label for="Cedula" class="col-md-4 col-form-label">Cedula:</label></td>
                                    <td><input type="text" class="form-control" size="15" name="Cedula" value="' . $this->Cedula . '" required></td>
                                </tr>
                                <tr>
                                    <td><label for="Edad" class="col-md-4 col-form-label">Edad:</label></td>
                                    <td><input type="text" class="form-control" size="15" name="Edad" value="' . $this->Edad . '" required></td>
                                </tr>
                                <tr>
                                    <td><label for="Genero" class="col-md-4 col-form-label">Genero:</label></td>
                                    <td><div class="col-md-8">' . $this->_get_radio($Genero, "Genero", $this->Genero) . '</div></td>
                                </tr>
                                <tr>
                                    <td><label for="Estatura" class="col-md-4 col-form-label">Estatura:</label></td>
                                    <td><input type="text" class="form-control" size="15" name="Estatura" value="' . $this->Estatura . '" required></td>
                                </tr>
                                <tr>
                                    <td><label for="Peso" class="col-md-4 col-form-label">Peso:</label></td>
                                    <td><input type="text" class="form-control" size="15" name="Peso" value="' . $this->Peso . '" required></td>
                                </tr>
                                <tr>
        ...
        <th colspan="2"><input type="submit" class="btn btn-primary" name="" value="REGRESAR"></th>
            ...
            <table class="table table-bordered text-center table-striped" align="center">
                <thead >
                    ...
                    <tr>
                        <th colspan="12" class="text-center" style="background-color: #5BAC87;"><a href="paciente.php?d=' . $d_new_final . '" class= "text-white">Nuevo</a></th>
                    </tr>
                    <tr>
                        <th>Usuario</th>
                        <th>Paciente</th>
