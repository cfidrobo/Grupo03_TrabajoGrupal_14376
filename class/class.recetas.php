...
class recetas
{
    ...
    public function get_list()
    {
        ...
        $html = '
        <div class="container">
        <form action="../login/recursos/index1.php" method="get">
            ...
            <table class="table table-bordered text-center table-striped" align="center">
                <thead >
                    ...
                    <tr>
                        <th colspan="8" class="text-center" style="background-color: #5BAC87;"><a href="receta.php?d=' . $d_new_final . '"class= "text-white">Nuevo</a></th>
                    </tr>
                    <tr>
                        <th>Paciente</th>
                        <th>Medicamento</th>
