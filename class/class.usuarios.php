	...
	public function get_form($idusuario = NULL)
{
    if ($idusuario == NULL) {
        ...
        $flag = "enabled"; // Para el formulario nuevo
        $op = "new";
    } else {
...
return $html;
		...
		<form action="../login/recursos/index.php" method="get">
			...
			<tr class= "active">
				<th colspan="9" >Lista de Usuarios</th>
					...
					<tr>
					<th colspan="9" class="text-center" style="background-color: #5BAC87;"><a href="usuarios.php?d=' . $d_new_final . '">Nuevo</a></th>
				</tr>
	...
	public function get_detail_usuarios($idusuario)
	{
		...
		if ($num == 0) {
			...
			// Obtén el tipo de imagen y la ruta correspondiente
